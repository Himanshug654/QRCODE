...
import 'package:qrcode/app/utils/fade_route.dart';
...
class NavigationUtilities {
  ...
  static Future<dynamic> pushRoute(String route,
    ...
    args["routeType"] = RouteType.slideIn;
...
Route<dynamic> onGenerateRoute(RouteSettings settings) {
  ...
  switch (routeName) {
    case ScanQRCodeScreen.route:
      screen=ScanQRCodeScreen();
      break;
    case ScanResults.route:
      screen= ScanResults(arguments);
  }
